...
void main()=> runApp(EndGameApp());

class EndGameApp estands StatelesWidget{
@override
...
class ListInfinitySaga extends State<InfinitySaga>{
  ...
  Future<List<InfinityComic>> _getComics() async{
    ...
    var md5D = generateMd5("${now}TUS LLAVES");
    var url = "https://gateway.marvel.com/v1/public/series?title=infinity gauntlet&ts=${now}&apikey=LLAVE PUBLIC&hash=${md5D}";
    print(url);
